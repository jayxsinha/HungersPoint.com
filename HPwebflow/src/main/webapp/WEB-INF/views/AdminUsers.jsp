...
<p><Strong>Welcome to the Admin Users Page</Strong>
<br><br><a href="/HPbackend/adminUsersTable">See the Present Available Users</a>
<br><br>
</p>
<c:url var="addAction" value="/adminUsers"></c:url>
<form:form commandName="users" action="${addAction}" >
