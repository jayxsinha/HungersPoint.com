			...
			<div class="panel panel-info" >
				...
				<c:forEach items="${cartList}" var="cart">
					<div class="row">
						...
						<div class="col-xs-3">
							<h4  class="product-name"><strong>${cart.prd.pname}</strong></h4><h4><small>Product description</small></h4>
						</div>
						<div class="col-xs-6">
							...
							<div class="col-xs-4">
								<input  type="text" class="form-control input-sm" value="${cart.quantity}"  name = "Quantity">
							</div>
							<div class="col-xs-2">

											<a href="<c:url value='cart/delete/${cart.cartId}' />"><button
