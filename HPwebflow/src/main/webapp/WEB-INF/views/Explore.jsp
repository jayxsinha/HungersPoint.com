  ...
  <div class="row">
    <div class="col-sm-4">
      <div class="panel panel-primary">
        <div class="panel-heading">Indian</div>
        <div class="panel-body"><img src="resources/SouthIndianCuisine.jpg" class="img-responsive" style="width:100%" alt="Image"></div>
        <div class="panel-footer">Explore North and South Indian Dishes</div>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="panel panel-primary">
        <div class="panel-heading">Italian</div>
        <div class="panel-body"><img src="resources/Pizza.jpg" class="img-responsive" style="width:100%" alt="Image"></div>
        <div class="panel-footer">Explore Italian Dishes</div>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="panel panel-primary">
        <div class="panel-heading">American</div>
        <div class="panel-body"><img src="resources/Burger.jpg" class="img-responsive" style="width:100%" alt="Image"></div>
        <div class="panel-footer">Explore the taste of America</div>
      </div>
    </div>
  </div>
</div><br>
...
<div class="container">
  <div class="row">
    <div class="col-sm-4">
      <div class="panel panel-primary">
        ...
        <div class="panel-body"><img src="resources/ChineseNoodles.jpg" class="img-responsive" style="width:100%" alt="Image"></div>
        <div class="panel-footer">Explore the Chinese Delicacies</div>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="panel panel-primary">
        <div class="panel-heading">Thai</div>
        <div class="panel-body"><img src="resources/Thai.jpg" class="img-responsive" style="width:100%" alt="Image"></div>
        <div class="panel-footer">Explore the taste of Thailand</div>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="panel panel-primary">
        <div class="panel-heading">Mexican</div>
        <div class="panel-body"><img src="resources/MexicanTacos.jpg" class="img-responsive" style="width:100%" alt="Image"></div>
        <div class="panel-footer">Wanna try the Mexican Thing?</div>
      </div>
    </div>
  </div>
</div><br><br>
  ...
  <div class="row">
    <div class="col-sm-4">
      <div class="panel panel-primary">
        <div class="panel-heading">Hurry Mode</div>
        <div class="panel-body"><img src="resources/hurry.jpg" class="img-responsive" style="width:100%" alt="Image"></div>
        <div class="panel-footer">Explore the Hurry Mode</div>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="panel panel-primary">
        <div class="panel-heading">Deciding Mode</div>
        <div class="panel-body"><img src="resources/Deciding.jpg" class="img-responsive" style="width:100%" alt="Image"></div>
        <div class="panel-footer">Now buy Delicious Food with speed and accuracy!</div>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="panel panel-primary">
        <div class="panel-heading">Conscious Mode</div>
        <div class="panel-body"><img src="resources/Calorie.jpg" class="img-responsive" style="width:100%" alt="Image"></div>
        <div class="panel-footer">Care about every extra Calorie? Don't worry, try our Conscious Mode and adjust your Calorie Intake!</div>
      </div>
    </div>
  </div>
</div>
