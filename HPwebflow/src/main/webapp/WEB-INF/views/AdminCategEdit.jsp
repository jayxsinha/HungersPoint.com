...
<c:url var="addAction" value="/adminCategUpdate"></c:url>
<form:form commandName="categ1" action="${addAction}" >

<div class="form-group">
				<c:choose>
			   		<c:when test="${categ1.cid >0}">
                  		<label class="control-label">Enter ID: </label>
                  		<form:input class="form-control" placeholder="Enter Category ID" type="text" path="cid" disabled="true" readonly="true"/>
