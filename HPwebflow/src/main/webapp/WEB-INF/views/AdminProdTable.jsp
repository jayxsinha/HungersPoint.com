...
<table class="table table-striped table-hover">
	<thead>
	<tr>
	<th ng-click="sort('cid')">Prod Id 
	<span class="glyphicon sort-icon" ng-show="sortKey=='pid'"
			ng-class="{'glyphicon-chevron-up':reverse,'glyphicon-chevron-down':!reverse}"></span>
	</th>
						
	<th ng-click="sort('cname')">Prod Name 
	<span class="glyphicon sort-icon" ng-show="sortKey=='pname'"
			ng-class="{'glyphicon-chevron-up':reverse,'glyphicon-chevron-down':!reverse}"></span>
	</th>
						
	<th ng-click="sort('caddress')">Prod Desc 
	<span class="glyphicon sort-icon" ng-show="sortKey=='pdes'"
			ng-class="{'glyphicon-chevron-up':reverse,'glyphicon-chevron-down':!reverse}"></span>
	</th>
						
	<th ng-click="sort('cphone')">Prod Cook 
	<span class="glyphicon sort-icon" ng-show="sortKey=='cook'"
			ng-class="{'glyphicon-chevron-up':reverse,'glyphicon-chevron-down':!reverse}"></span>
	</th>
	
	<th ng-click="sort('cphone')">Prod Rating 
	<span class="glyphicon sort-icon" ng-show="sortKey=='rating'"
			ng-class="{'glyphicon-chevron-up':reverse,'glyphicon-chevron-down':!reverse}"></span>
	</th>
	...
	<tr ng-repeat="prod in list|orderBy:sortKey:reverse|filter:search">
		<td>{{prod.pid}}</td>
		<td>{{prod.pname}}</td>
		<td>{{prod.pdes}}</td>
		<td>{{prod.cook.fname}}</td>
		<td>{{prod.rating}}</td>
 		<td style="color:#000000;font-size:120%" align="left"><a href="<c:url value='adminProd/edit/{{prod.pid}}' />"><button type="button" class="btn btn-warning">Edit</button></a></td> 
		<td style="color:#000000;font-size:120%" align="left"><a href="<c:url value='cart/add/{{prod.pid}}' />"><button type="button" class="btn btn-danger">Add In cart</button></a></td>
		<td style="color:#000000;font-size:120%" align="left"><a href="<c:url value='adminProd/delete/{{prod.pid}}' />"><button type="button" class="btn btn-danger">Delete</button></a></td>
	</tr>
	</tbody>
	</table>
