...
<table class="table table-striped table-hover">
	...
	<th ng-click="sort('caddress')">User Last Name 
	<span class="glyphicon sort-icon" ng-show="sortKey=='lname'"
			ng-class="{'glyphicon-chevron-up':reverse,'glyphicon-chevron-down':!reverse}"></span>
	</th>
						
	<th ng-click="sort('cphone')">User E-Mail 
	<span class="glyphicon sort-icon" ng-show="sortKey=='email'"
			ng-class="{'glyphicon-chevron-up':reverse,'glyphicon-chevron-down':!reverse}"></span>
	</th>
	
	<th ng-click="sort('cphone')">User Phone 
	...
	<tr ng-repeat="user in list|orderBy:sortKey:reverse|filter:search">
		...
		<td>{{user.email}}</td>
		<td>{{user.phone}}</td>
 		<td style="color:#000000;font-size:120%" align="center"><a href="<c:url value='adminUsers/edit/{{user.id}}' />"><button type="button" class="btn btn-warning">Edit</button></a></td> 
		<td style="color:#000000;font-size:120%" align="center"><a href="<c:url value='adminUsers/remove/{{user.id}}' />"><button type="button" class="btn btn-danger">Delete</button></a></td>
	</tr>
	</tbody>
	</table>
