...
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd"><%@ taglib uri="http://www.springframework.org/tags/form" prefix="form" %>
...
<c:url var="addAction" value="/adminUsers"></c:url>
<form:form commandName="user1" action="${addAction}" >

<div class="form-group">
				<c:choose>
			   		<c:when test="${user1.id >0}">
                  		<label class="control-label">Enter ID: </label>
                  		<form:input class="form-control" placeholder="Enter Category ID" type="text" path="id" disabled="true" readonly="true"/>
                  		<form:hidden path="id" />
                  	</c:when>
					<c:otherwise>
                		<label class="control-label">Enter ID: </label>
...
<form:input class="form-control" placeholder="Enter the First Name" type="text" path="fname"/>
<form:errors path="fname" cssClass="error"/>
</div>

<div class="from-group">
<label class="control-label">Enter Last Name: </label> 
<form:input class="form-control" placeholder="Enter the Last Name" type="text" path="lname"/>
<form:errors path="lname" cssClass="error"/>
</div>

<div class="from-group">
<label class="control-label">Enter Address: </label> 
<form:input class="form-control" placeholder="Enter the Address" type="text" path="address"/>
<form:errors path="address" cssClass="error"/>
</div>

<div class="from-group">
<label class="control-label">Enter Phone:</label>
<form:input class="form-control" placeholder="Enter the Phone Number" type="number" path="phone"/>
<form:errors path="phone" cssClass="error"/>
</div>

<div class="from-group">
<label class="control-label">Enter E-Mail: </label> 
<form:input class="form-control" placeholder="Enter the E-Mail" type="text" path="email"/>
<form:errors path="email" cssClass="error"/>
</div>

<div class="from-group">
<label class="control-label">Enter Password: </label> 
<form:input class="form-control" placeholder="Enter the Password" type="password" path="password"/>
<form:errors path="address" cssClass="error"/>
</div>

<div class="from-group">
<label class="control-label">Enter DOB: </label> 
<form:input class="form-control" placeholder="Enter the Date of Birth" type="text" path="DOB"/>
